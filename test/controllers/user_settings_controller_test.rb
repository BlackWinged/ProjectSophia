...
class UserSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_setting" do
    assert_difference('UserSetting.count') do
      post user_settings_url, params: { user_setting: { baseInterval: @user_setting.baseInterval, increaseMultiplier: @user_setting.increaseMultiplier, integer: @user_setting.integer } }
    end
  ...
  test "should update user_setting" do
    patch user_setting_url(@user_setting), params: { user_setting: { baseInterval: @user_setting.baseInterval, increaseMultiplier: @user_setting.increaseMultiplier, integer: @user_setting.integer } }
